...
export const COMPANY_NAME = "The AC Wallah";
export const BRAND_NAME = "The AC Wallah Delhi";
export const PHONE_NUMBER = "+918521123304";
export const WHATSAPP_NUMBER = "918521123304";
export const EMAIL = "contact@theacwallah.com";
